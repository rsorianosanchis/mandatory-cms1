                ...
                <div class="uk-panel uk-panel-box uk-panel-card uk-panel-card-hover">
                    ...
                    <div class="uk-grid uk-grid-small">
                        ...
                        <div data-uk-dropdown="delay:300">
                            ...
                            <a aria-label="<?php echo $app("i18n")->get('Edit collection'); ?>" class="uk-icon-cog" style="color:{ (collection.meta.color) }" href="<?php $app->route('/collections/collection'); ?>/{ collection.name }" if="{ collection.meta.allowed.edit }"></a>
