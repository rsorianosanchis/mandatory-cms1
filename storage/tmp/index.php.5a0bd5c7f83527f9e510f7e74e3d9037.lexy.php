    ...
    <div class="uk-grid">
        <div class="uk-width-2-3">
            ...
            <div class="uk-grid uk-grid-small uk-flex-middle uk-margin-top">
                ...
                <div if="{keys.master}">
                    <a class="uk-margin-right" onclick="{ copyApiKey }" title="<?php echo $app("i18n")->get('Copy Token'); ?>" data-uk-tooltip="pos:'top'"><i class="uk-icon-copy"></i></a>
                    ...
                    <div class="uk-panel uk-panel-box uk-panel-card uk-flex-item-1 uk-margin-right">
                        ...
                        <div class="uk-form-row">
                            ...
                            <div class="uk-flex uk-flex-middle">
                                ...
                                <a class="uk-margin-right" onclick="{ parent.copyApiKey }" title="<?php echo $app("i18n")->get('Copy Token'); ?>" data-uk-tooltip="pos:'top'"><i class="uk-icon-copy"></i></a>
