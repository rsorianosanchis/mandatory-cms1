                            ...
                            <div class="uk-form-row">
                                ...
                                <div class="uk-flex uk-flex-middle">
                                    <div class="uk-form-icon uk-display-block uk-flex-item-1">
                                        ...
                                        <input class="uk-form-large uk-width-1-1" type="text" bind="account.api_key" placeholder="<?php echo $app("i18n")->get('No token generated yet'); ?>" aria-label="<?php echo $app("i18n")->get('Api token'); ?>" bind="account.apikey" disabled>
                                    </div>
